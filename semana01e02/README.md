...
Nesta semana, trabalhei a construção e representação de uma solução computacional, passando da ideia inicial para uma representação estruturada por meio de um fluxograma e sua implementação em Assembly.
